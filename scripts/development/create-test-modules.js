...
function createTestModules() {
    return __awaiter(this, void 0, void 0, function () {
        var courseRepository, moduleRepository, testCourse, existingModules, modules, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    existingModules = _a.sent();
                    if (existingModules.length > 0) {
                        console.log("\u2705 Test Course already has ".concat(existingModules.length, " modules"));
                        return [2 /*return*/];
                    }
                    modules = [
                        {
                    ...
                    return [4 /*yield*/, moduleRepository.save(modules)];
                case 4:
                    _a.sent();
                    console.log("\u2705 Created ".concat(modules.length, " modules for Test Course"));
                    return [3 /*break*/, 9];
                case 5:
                    error_1 = _a.sent();
                    ...
                    return [3 /*break*/, 9];
                case 6:
                    if (!data_source_1.default.isInitialized) return [3 /*break*/, 8];
