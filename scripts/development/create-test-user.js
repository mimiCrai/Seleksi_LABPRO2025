...
function createTestUser() {
    return __awaiter(this, void 0, void 0, function () {
        var userRepository, existingUser, hashedPassword, testUser, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    return [4 /*yield*/, userRepository.save(testUser)];
                case 4:
                    _a.sent();
                    console.log('✅ Created testuser with password: password123');
                    console.log("   User ID: ".concat(testUser.id));
                    console.log("   Balance: ".concat(testUser.balance, " credits"));
                    return [3 /*break*/, 9];
                case 5:
                    error_1 = _a.sent();
